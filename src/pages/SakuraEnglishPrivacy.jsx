    ...
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">SakuraEnglish</p>
        ...
        <div className="space-y-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">はじめに</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Sakura Apps（以下「当社」）は、SakuraEnglishアプリ（以下「本アプリ」）をご利用いただくユーザーの皆様のプライバシーを尊重し、
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">収集する情報</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <div>
                <h3 className="font-semibold mb-2">1. 学習データ</h3>
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>学習進捗情報（習得した単語、学習時間、正答率など）</li>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">情報の利用目的</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>収集した情報は以下の目的で利用いたします：</p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>学習体験の個人化とカスタマイズ</li>
                <li>学習進捗の記録と分析</li>
                <li>アプリの機能改善とバグ修正</li>
                <li>新機能の開発と提供</li>
                <li>カスタマーサポートの提供</li>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">情報の共有</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">データの安全性</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">ユーザーの権利</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>ユーザーは以下の権利を有します：</p>
              <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">データの保存期間</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">プライバシーポリシーの変更</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-xl text-blue-600">お問い合わせ</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-700 leading-relaxed">
              <p>
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
          <Button asChild variant="outline">
            <Link to="/sakura-english">SakuraEnglishに戻る</Link>
          </Button>
          <Button asChild>
...
export default SakuraEnglishPrivacy
